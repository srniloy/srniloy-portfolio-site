        ...
        const animateLogo = async () => {
            ...
            // 2. Move to navbar position (only on homepage)
                ...
                if (navbar && navbarCon && logo && logoRef.current) {
                    ...
                    // x = 0
                    let y = navbarRect.top + (navbarRect.height / 2) - logoRect.top - (logoRect.height / 2) - 2;
                    // y = - 273
                    ...
                    document.querySelector('.animated-logo')?.classList.remove('hidden')
                    await controls.start({
                        opacity:0,
                    });
                }
